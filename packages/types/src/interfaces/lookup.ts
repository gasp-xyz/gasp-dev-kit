...
export default {
  ...
  /**
   * Lookup297: pallet_rolldown::pallet::DisputeRole
   **/
  ...
  /**
   * Lookup316: pallet_transaction_payment_mangata::Releases
   **/
  PalletTransactionPaymentMangataReleases: {
    _enum: ['V1Ancient', 'V2']
  },
  /**
   * Lookup318: pallet_xyk::pallet::Error<T>
   **/
  PalletXykError: {
  ...
  /**
   * Lookup319: pallet_proof_of_stake::reward_info::RewardInfo<Balance>
   **/
  ...
  /**
   * Lookup321: pallet_proof_of_stake::pallet::PromotedPools
   **/
  ...
  /**
   * Lookup325: pallet_proof_of_stake::schedule_rewards_calculator::ScheduleRewards<Balance>
   **/
  ...
  /**
   * Lookup332: pallet_proof_of_stake::SchedulesList
   **/
  ...
  /**
   * Lookup334: pallet_proof_of_stake::Schedule<T>
   **/
  ...
  /**
   * Lookup335: pallet_proof_of_stake::schedule_rewards_calculator::ActivatedLiquidityPerSchedule<Balance>
   **/
  ...
  /**
   * Lookup337: pallet_proof_of_stake::pallet::Error<T>
   **/
  ...
  /**
   * Lookup338: pallet_fee_lock::pallet::FeeLockMetadataInfo<T>
   **/
  ...
  /**
   * Lookup341: pallet_fee_lock::pallet::AccountFeeLockDataInfo<BlockNumber, Balance>
   **/
  ...
  /**
   * Lookup342: pallet_fee_lock::pallet::Error<T>
   **/
  PalletFeeLockError: {
  ...
  /**
   * Lookup345: pallet_vesting_mangata::Releases
   **/
  PalletVestingMangataReleases: {
    _enum: ['V0', 'V1']
  },
  /**
   * Lookup346: pallet_vesting_mangata::pallet::Error<T>
   **/
  ...
  /**
   * Lookup348: pallet_crowdloan_rewards::pallet::RewardInfo<T>
   **/
  ...
  /**
   * Lookup349: pallet_crowdloan_rewards::pallet::Error<T>
   **/
  ...
  /**
   * Lookup407: pallet_sequencer_staking::pallet::Error<T>
   **/
  ...
  /**
   * Lookup411: sp_core::crypto::KeyTypeId
   **/
  SpCoreCryptoKeyTypeId: '[u8;4]',
  /**
   * Lookup412: pallet_session::pallet::Error<T>
   **/
  PalletSessionError: {
  ...
  /**
   * Lookup420: orml_asset_registry::module::Error<T>
   **/
  ...
  /**
   * Lookup421: pallet_treasury::Proposal<sp_runtime::account::AccountId20, Balance>
   **/
  ...
  /**
   * Lookup424: pallet_sudo_mangata::pallet::Error<T>
   **/
  PalletSudoMangataError: {
    _enum: ['RequireSudo']
  },
  /**
   * Lookup425: pallet_sudo_origin::pallet::Error<T>
   **/
  PalletSudoOriginError: 'Null',
  /**
   * Lookup427: pallet_collective_mangata::Votes<sp_runtime::account::AccountId20, BlockNumber>
   **/
  ...
  /**
   * Lookup428: pallet_collective_mangata::pallet::Error<T, I>
   **/
  ...
  /**
   * Lookup437: pallet_identity::types::RegistrarInfo<Balance, sp_runtime::account::AccountId20>
   **/
  ...
  /**
   * Lookup442: frame_system::extensions::check_spec_version::CheckSpecVersion<T>
   **/
  FrameSystemExtensionsCheckSpecVersion: 'Null',
  /**
   * Lookup443: frame_system::extensions::check_tx_version::CheckTxVersion<T>
   **/
  ...
  /**
   * Lookup449: pallet_transaction_payment_mangata::ChargeTransactionPayment<T>
   **/
  ...
  /**
   * Lookup451: rollup_runtime::Runtime
   **/
