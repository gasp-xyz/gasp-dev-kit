...
declare module '@polkadot/api-base/types/submittable' {
  interface AugmentedSubmittables<ApiType extends ApiTypes> {
    assetRegistry: {
      ...
      registerL1Asset: AugmentedSubmittable<(metadata: OrmlTraitsAssetRegistryAssetMetadata | { decimals?: any; name?: any; symbol?: any; existentialDeposit?: any; additional?: any } | string | Uint8Array, assetId: Option<u32> | null | Uint8Array | u32 | AnyNumber, l1Asset: ITuple<[u64, U8aFixed]> | [u64 | AnyNumber | Uint8Array, U8aFixed | string | Uint8Array]) => SubmittableExtrinsic<ApiType>, [OrmlTraitsAssetRegistryAssetMetadata, Option<u32>, ITuple<[u64, U8aFixed]>]>;
      ...
      updateL1AssetData: AugmentedSubmittable<(assetId: u32 | AnyNumber | Uint8Array, l1Asset: Option<ITuple<[u64, U8aFixed]>> | null | Uint8Array | ITuple<[u64, U8aFixed]> | [u64 | AnyNumber | Uint8Array, U8aFixed | string | Uint8Array]) => SubmittableExtrinsic<ApiType>, [u32, Option<ITuple<[u64, U8aFixed]>>]>;
      /**
       * Generic tx
       **/
    ...
    rolldown: {
      cancelRequestsFromL1: AugmentedSubmittable<(chain: u64 | AnyNumber | Uint8Array, requestsToCancel: u128 | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>, [u64, u128]>;
      createBatch: AugmentedSubmittable<(chain: u64 | AnyNumber | Uint8Array, sequencerAccount: Option<SpRuntimeAccountAccountId20> | null | Uint8Array | SpRuntimeAccountAccountId20 | string) => SubmittableExtrinsic<ApiType>, [u64, Option<SpRuntimeAccountAccountId20>]>;
      ferryDeposit: AugmentedSubmittable<(chain: u64 | AnyNumber | Uint8Array, requestId: PalletRolldownMessagesRequestId | { origin?: any; id?: any } | string | Uint8Array, depositRecipient: U8aFixed | string | Uint8Array, tokenAddress: U8aFixed | string | Uint8Array, amount: u128 | AnyNumber | Uint8Array, timestamp: u128 | AnyNumber | Uint8Array, ferryTip: u128 | AnyNumber | Uint8Array, depositHash: H256 | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [u64, PalletRolldownMessagesRequestId, U8aFixed, U8aFixed, u128, u128, u128, H256]>;
      ferryDepositUnsafe: AugmentedSubmittable<(chain: u64 | AnyNumber | Uint8Array, requestId: PalletRolldownMessagesRequestId | { origin?: any; id?: any } | string | Uint8Array, depositRecipient: U8aFixed | string | Uint8Array, tokenAddress: U8aFixed | string | Uint8Array, amount: u128 | AnyNumber | Uint8Array, timestamp: u128 | AnyNumber | Uint8Array, ferryTip: u128 | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>, [u64, PalletRolldownMessagesRequestId, U8aFixed, U8aFixed, u128, u128, u128]>;
      forceCancelRequestsFromL1: AugmentedSubmittable<(chain: u64 | AnyNumber | Uint8Array, requestsToCancel: u128 | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>, [u64, u128]>;
      /**
       ...
       **/
      forceCreateBatch: AugmentedSubmittable<(chain: u64 | AnyNumber | Uint8Array, range: ITuple<[u128, u128]> | [u128 | AnyNumber | Uint8Array, u128 | AnyNumber | Uint8Array], sequencerAccount: SpRuntimeAccountAccountId20 | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [u64, ITuple<[u128, u128]>, SpRuntimeAccountAccountId20]>;
       ...
       **/
      refundFailedDeposit: AugmentedSubmittable<(chain: u64 | AnyNumber | Uint8Array, requestId: u128 | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>, [u64, u128]>;
      setDisputePeriod: AugmentedSubmittable<(chain: u64 | AnyNumber | Uint8Array, disputePeriodLength: u128 | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>, [u64, u128]>;
      ...
      withdraw: AugmentedSubmittable<(chain: u64 | AnyNumber | Uint8Array, recipient: U8aFixed | string | Uint8Array, tokenAddress: U8aFixed | string | Uint8Array, amount: u128 | AnyNumber | Uint8Array, ferryTip: Option<u128> | null | Uint8Array | u128 | AnyNumber) => SubmittableExtrinsic<ApiType>, [u64, U8aFixed, U8aFixed, u128, Option<u128>]>;
      /**
       * Generic tx
       **/
      [key: string]: SubmittableExtrinsicFunction<ApiType>;
    ...
    sequencerStaking: {
      leaveActiveSequencers: AugmentedSubmittable<(chain: u64 | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>, [u64]>;
      /**
       ...
       * join active set
       **/
      provideSequencerStake: AugmentedSubmittable<(chain: u64 | AnyNumber | Uint8Array, stakeAmount: u128 | AnyNumber | Uint8Array, aliasAccount: Option<SpRuntimeAccountAccountId20> | null | Uint8Array | SpRuntimeAccountAccountId20 | string, stakeAction: PalletSequencerStakingStakeAction | 'StakeOnly' | 'StakeAndJoinActiveSet' | number | Uint8Array, sender: SpRuntimeAccountAccountId20 | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [u64, u128, Option<SpRuntimeAccountAccountId20>, PalletSequencerStakingStakeAction, SpRuntimeAccountAccountId20]>;
      rejoinActiveSequencers: AugmentedSubmittable<(chain: u64 | AnyNumber | Uint8Array, sender: SpRuntimeAccountAccountId20 | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [u64, SpRuntimeAccountAccountId20]>;
      setSequencerConfiguration: AugmentedSubmittable<(chain: u64 | AnyNumber | Uint8Array, minimalStakeAmount: u128 | AnyNumber | Uint8Array, slashFineAmount: u128 | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>, [u64, u128, u128]>;
      /**
       ...
       * alias_account for another sequencer
       **/
      setUpdaterAccountForSequencer: AugmentedSubmittable<(chain: u64 | AnyNumber | Uint8Array, aliasAccount: Option<SpRuntimeAccountAccountId20> | null | Uint8Array | SpRuntimeAccountAccountId20 | string) => SubmittableExtrinsic<ApiType>, [u64, Option<SpRuntimeAccountAccountId20>]>;
      unstake: AugmentedSubmittable<(chain: u64 | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>, [u64]>;
      /**
       * Generic tx
       **/
      [key: string]: SubmittableExtrinsicFunction<ApiType>;
