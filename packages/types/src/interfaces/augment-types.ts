...
import type { CancelResolution, Chain, Deposit, L1Update, L2UpdatesToRemove, MultiswapBuyInfo, MultiswapSellInfo, PalletMarketPoolKind, RequestId, RpcAssetMetadata, RpcPoolInfo, ShufflingSeed, TokenId, WithdrawalResolution } from 'gasp-types/interfaces/default';
...
declare module '@polkadot/types/types/registry' {
  interface InterfaceTypes {
    ...
    MultiswapBuyInfo: MultiswapBuyInfo;
    MultiswapSellInfo: MultiswapSellInfo;
    NetworkId: NetworkId;
