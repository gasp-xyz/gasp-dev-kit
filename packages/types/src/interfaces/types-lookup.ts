...
declare module '@polkadot/types/lookup' {
  ...
  /** @name PalletMetamaskSignatureEvent (53) */
  ...
  /** @name FrameSupportTokensMiscBalanceStatus (60) */
  ...
  /** @name PalletProofOfStakeEvent (66) */
  ...
  /** @name PalletVestingMangataEvent (68) */
  ...
  /** @name PalletIssuanceIssuanceInfo (71) */
  ...
  /** @name PalletIssuanceTgeInfo (73) */
  interface PalletIssuanceTgeInfo extends Struct {
    readonly who: SpRuntimeAccountAccountId20;
    readonly amount: u128;
  }

  /** @name PalletMultipurposeLiquidityEvent (74) */
  ...
  /** @name ParachainStakingCandidateBondRequest (77) */
  ...
  /** @name ParachainStakingCandidateBondChange (78) */
  ...
  /** @name ParachainStakingDelegationRequest (79) */
  ...
  /** @name ParachainStakingDelegationChange (80) */
  ...
  /** @name ParachainStakingDelegatorAdded (81) */
  ...
  /** @name ParachainStakingPayoutRounds (82) */
  ...
  /** @name PalletSequencerStakingEvent (83) */
  ...
  /** @name PalletSequencerStakingPayoutRounds (85) */
  ...
  /** @name OrmlAssetRegistryModuleEvent (92) */
  ...
  /** @name OrmlTraitsAssetRegistryAssetMetadata (93) */
  ...
  /** @name MangataTypesAssetsCustomMetadata (94) */
  ...
  /** @name PalletSudoMangataEvent (101) */
  ...
  /** @name PalletSudoOriginEvent (102) */
  ...
  /** @name PalletCollectiveMangataEvent (103) */
  ...
  /** @name PalletUtilityMangataCall (131) */
  ...
  /** @name PalletMaintenanceCall (136) */
  ...
  /** @name PalletRolldownMessagesL1Update (138) */
  ...
  /** @name PalletRolldownMessagesDeposit (140) */
  ...
  /** @name PalletRolldownMessagesCancelResolution (144) */
  ...
  /** @name PalletMetamaskSignatureCall (145) */
  ...
  /** @name PalletProofOfStakeCall (151) */
  ...
  /** @name MangataTypesMultipurposeLiquidityActivateKind (153) */
  ...
  /** @name PalletProofOfStakeThirdPartyActivationKind (155) */
  ...
  /** @name PalletVestingMangataCall (160) */
  ...
  /** @name PalletVestingMangataVestingInfo (161) */
  ...
  /** @name PalletCrowdloanRewardsCall (162) */
  ...
  /** @name SpRuntimeAccountEthereumSignature (163) */
  interface SpRuntimeAccountEthereumSignature extends SpCoreEcdsaSignature {}

  /** @name SpCoreEcdsaSignature (164) */
  interface SpCoreEcdsaSignature extends U8aFixed {}

  /** @name PalletIssuanceCall (170) */
  ...
  /** @name PalletMultipurposeLiquidityCall (172) */
  ...
  /** @name MangataTypesMultipurposeLiquidityBondKind (177) */
  ...
  /** @name ParachainStakingPairedOrLiquidityToken (178) */
  ...
  /** @name ParachainStakingMetadataUpdateAction (179) */
  ...
  /** @name PalletSequencerStakingCall (180) */
  ...
  /** @name PalletSequencerStakingStakeAction (181) */
  ...
  /** @name RollupRuntimeSessionKeys (183) */
  ...
  /** @name SpConsensusGrandpaEquivocationProof (187) */
  interface SpConsensusGrandpaEquivocationProof extends Struct {
    readonly setId: u64;
    readonly equivocation: SpConsensusGrandpaEquivocation;
  }

  /** @name SpConsensusGrandpaEquivocation (188) */
  ...
  /** @name SpConsensusGrandpaAppSignature (191) */
  ...
  /** @name OrmlAssetRegistryModuleCall (199) */
  ...
  /** @name MangataTypesAssetsL1Asset (202) */
  ...
  /** @name PalletSudoMangataCall (205) */
  ...
  /** @name PalletCollectiveMangataCall (207) */
  ...
  /** @name PalletIdentityLegacyIdentityInfo (209) */
  ...
  /** @name RollupRuntimeOriginCaller (248) */
  ...
  /** @name PalletCollectiveMangataRawOrigin (250) */
  ...
  /** @name PalletUtilityMangataError (251) */
  ...
  /** @name PalletMaintenanceMaintenanceStatusInfo (261) */
  ...
  /** @name PalletMaintenanceError (262) */
  ...
  /** @name PalletRolldownMessagesWithdrawal (279) */
  ...
  /** @name PalletRolldownDisputeRole (283) */
  ...
  interface PalletRolldownError extends Enum {
    ...
    readonly isNotDepositRecipient: boolean;
  ...
  /** @name OrmlTokensReserveData (298) */
  interface OrmlTokensReserveData extends Struct {
    readonly id: U8aFixed;
    readonly amount: u128;
  }

  /** @name OrmlTokensModuleError (300) */
  ...
  /** @name PalletProofOfStakeRewardInfo (305) */
  ...
  /** @name PalletProofOfStakePromotedPools (307) */
  interface PalletProofOfStakePromotedPools extends Struct {
    readonly weight: u8;
    readonly rewards: U256;
  }

  /** @name PalletProofOfStakeScheduleRewardsCalculatorScheduleRewards (311) */
  ...
  /** @name PalletProofOfStakeSchedulesList (318) */
  ...
  /** @name PalletProofOfStakeSchedule (320) */
  ...
  /** @name PalletProofOfStakeScheduleRewardsCalculatorActivatedLiquidityPerSchedule (321) */
  ...
  /** @name PalletProofOfStakeError (323) */
  ...
  /** @name PalletFeeLockFeeLockMetadataInfo (324) */
  ...
  /** @name PalletFeeLockAccountFeeLockDataInfo (327) */
  ...
  /** @name PalletVestingMangataReleases (331) */
  ...
  /** @name PalletVestingMangataError (332) */
  ...
  /** @name PalletCrowdloanRewardsRewardInfo (334) */
  ...
  /** @name PalletMultipurposeLiquidityReserveStatusInfo (340) */
  ...
  /** @name PalletMultipurposeLiquidityRelockStatusInfo (342) */
  ...
  /** @name PalletMultipurposeLiquidityError (344) */
  ...
  /** @name PalletSequencerStakingError (394) */
  ...
  /** @name OrmlAssetRegistryModuleError (407) */
  ...
  /** @name PalletTreasurySpendStatus (410) */
  ...
  /** @name PalletTreasuryPaymentState (411) */
  ...
  /** @name PalletSudoMangataError (413) */
  interface PalletSudoMangataError extends Enum {
    readonly isRequireSudo: boolean;
    readonly type: 'RequireSudo';
  }

  /** @name PalletSudoOriginError (414) */
  type PalletSudoOriginError = Null;

  /** @name PalletCollectiveMangataVotes (416) */
  ...
  /** @name PalletCollectiveMangataError (417) */
  ...
  /** @name PalletIdentityAuthorityProperties (430) */
