...
declare module '@polkadot/types/lookup' {
  ...
  /** @name StagingXcmVersionedMultiLocation (101) */
  ...
  /** @name StagingXcmV2NetworkId (106) */
  ...
  /** @name StagingXcmV3Junctions (112) */
  ...
  /** @name StagingXcmV3JunctionNetworkId (115) */
  ...
  /** @name StagingXcmV3JunctionBodyId (116) */
  ...
  /** @name StagingXcmV3JunctionBodyPart (117) */
  ...
  /** @name PalletSudoMangataEvent (119) */
  ...
  /** @name PalletSudoOriginEvent (120) */
  ...
  /** @name PalletCollectiveMangataEvent (121) */
  ...
  /** @name PalletUtilityMangataCall (146) */
  ...
  /** @name PalletMaintenanceCall (151) */
  ...
  /** @name PalletRolldownMessagesL1Update (153) */
  ...
  /** @name PalletRolldownMessagesDeposit (155) */
  ...
  /** @name PalletRolldownMessagesCancelResolution (159) */
  ...
  /** @name SpRuntimeAccountEthereumSignature (177) */
  interface SpRuntimeAccountEthereumSignature extends SpCoreEcdsaSignature {}

  /** @name SpCoreEcdsaSignature (178) */
  interface SpCoreEcdsaSignature extends U8aFixed {}

  /** @name PalletIssuanceCall (184) */
  ...
  /** @name PalletMultipurposeLiquidityCall (186) */
  ...
  /** @name PalletSequencerStakingStakeAction (195) */
  ...
  /** @name RollupRuntimeSessionKeys (197) */
  ...
  /** @name PalletRolldownSequencerRights (287) */
  ...
  /** @name PalletRolldownMessagesWithdrawal (295) */
  ...
  /** @name PalletRolldownDisputeRole (299) */
  ...
  /** @name OrmlTokensReserveData (314) */
  interface OrmlTokensReserveData extends Struct {
    readonly id: U8aFixed;
    readonly amount: u128;
  }

  /** @name OrmlTokensModuleError (316) */
  ...
  /** @name PalletTransactionPaymentMangataReleases (318) */
